...
function BlogCard() {
  ...
  return (
    <div className="w-[384px]">
      ...
      <div className="mt-8">
        <p className="text-sm text-blog-card-purple font-semibold">{createTime}</p>
...
function Label({ label }: { label: BlogLabel }) {
  ...
  return (
    <div className={`h-6 rounded-full px-2.5 inline-flex items-center font-medium mr-2 ${color} ${bg}`}>
      {label}
    </div>
  )
}
